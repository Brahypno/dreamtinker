...
public class DreamtinkerRecipeProvider extends RecipeProvider implements IMaterialRecipeHelper, IToolRecipeHelper, IConditionBuilder, IRecipeHelper {
    ...
    private void addModifierRecipes(Consumer<FinishedRecipe> consumer) {
        ...
        ModifierRecipeBuilder.modifier(DreamtinkerModifers.Ids.continuous_explode)
                             .setTools(Ingredient.of(DreamtinkerItems.tntarrow.get()))
                             .addInput(TinkerGadgets.efln)
                             .addInput(Items.TNT)
                             .setMaxLevel(1)
                             .setSlots(SlotType.ABILITY, 1)
                             .saveSalvage(consumer, prefix(DreamtinkerModifers.Ids.continuous_explode, abilitySalvage))
                             .save(consumer, prefix(DreamtinkerModifers.Ids.continuous_explode, abilityFolder));
        ModifierRecipeBuilder.modifier(DreamtinkerModifers.Ids.continuous_explode)
                             .setTools(Ingredient.of(DreamtinkerItems.tntarrow.get()))
                             .addInput(Items.TNT)
                             .addInput(Tags.Items.GUNPOWDER)
        ...
        ModifierRecipeBuilder.modifier(DreamtinkerModifers.foundation_will)
                             .setTools(Ingredient.of(DreamtinkerItems.narcissus_wing))
                             .addInput(DreamtinkerItems.unborn_turtle_egg.get())
                             .addInput(DreamtinkerItems.unborn_turtle_egg.get())
                             .addInput(TinkerTags.Items.HARVEST_PRIMARY)
                             .setSlots(SlotType.UPGRADE, 1)
                             .saveSalvage(consumer, prefix(DreamtinkerModifers.foundation_will, upgradeSalvage))
                             .save(consumer, prefix(DreamtinkerModifers.foundation_will, upgradeFolder));
        ModifierRecipeBuilder.modifier(DreamtinkerModifers.Ids.huge_ego)
                             .addInput(DreamtinkerItems.persona_cast.get())
                             .addInput(DreamtinkerItems.persona_cast.get())
                             .setMaxLevel(3)
                             .save(consumer, prefix(DreamtinkerModifers.Ids.huge_ego, slotlessFolder));
    }
