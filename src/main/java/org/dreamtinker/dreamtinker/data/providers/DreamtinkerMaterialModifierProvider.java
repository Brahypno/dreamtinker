...
public class DreamtinkerMaterialModifierProvider extends AbstractMaterialTraitDataProvider {
    ...
    protected void addMaterialTraits() {
        addTraits(DreamtinkerMaterialIds.echo_shard, ARMOR, DreamtinkerModifer.echoed_defence);
        addTraits(DreamtinkerMaterialIds.echo_shard, MELEE_HARVEST, DreamtinkerModifer.echoed_attack);
        addTraits(DreamtinkerMaterialIds.echo_shard, RANGED, DreamtinkerModifer.echoed_attack);
