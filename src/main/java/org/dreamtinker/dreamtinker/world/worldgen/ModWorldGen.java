...
public class ModWorldGen {
    ...
    public static void bootstrapConfigured(BootstapContext<ConfiguredFeature<?, ?>> ctx) {
        ...
        register(ctx, configuredSmallBlackSapphireOre, Feature.ORE, new OreConfiguration(new BlockMatchTest(Blocks.END_STONE),DreamtinkerCommon.blackSapphireOre.get().defaultBlockState(), 6));
