...
import static org.dreamtinker.dreamtinker.tools.modifiers.traits.Compact.enigmaticLegacy.eldritch_pan.getBloodlust;
...
public class weapon_books extends BattleModifier {
    ...
    public void addTraits(IToolContext var1, ModifierEntry var2, TraitBuilder var3, boolean var4) {
        if (var4 && var2.getLevel() < 3 && 0 == var1.getModifierLevel(DreamtinkerModifiers.cursed_ring_bound.getId()))
            var3.add(DreamtinkerModifiers.cursed_ring_bound.getId(), 1);
        if (var4 && 3 == var2.getLevel() && var1.getModifierLevel(DreamtinkerModifiers.cursed_ring_bound.getId()) < 20)
