    ...
    protected void addAllMaterials() {
        ...
        this.buildMaterial(DreamtinkerMaterialIds.star_regulus)
            ...
            .transformer(GreyToSpriteTransformer.builderFromBlack()
                                                .addARGB(25, 0xFF2B0000)
                                                .addTexture(26, Dreamtinker.getLocation("material/star_regulus"))
                                                .addTexture(63, Dreamtinker.getLocation("material/star_regulus"))
                                                .addARGB(102, 0xFF6F0000)
                                                .addARGB(140, 0xFFD10000)
                                                .addARGB(178, 0xFFFF1A1A)
                                                .addARGB(216, 0xFFFF8080)
                                                .addARGB(255, 0xFFFFE6E6)
                                                .build());
