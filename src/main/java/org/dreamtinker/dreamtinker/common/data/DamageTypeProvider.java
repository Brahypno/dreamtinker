...
public class DamageTypeProvider implements RegistrySetBuilder.RegistryBootstrap<DamageType> {
    ...
    public void run(BootstapContext<DamageType> context) {
        ...
        context.register(tnt_arrow_force,
        ...
        context.register(many_wishes,
                         new DamageType(Dreamtinker.MODID + ".many_wishes", DamageScaling.WHEN_CAUSED_BY_LIVING_NON_PLAYER, 1f, DamageEffects.HURT));
        context.register(solar_judgment,
                         new DamageType(Dreamtinker.MODID + ".solar_judgment", DamageScaling.ALWAYS, 1f, DamageEffects.BURNING));
    }
