package org.dreamtinker.dreamtinker.Items.tools.TNTarrow;
    ...
    public static class TNTArrowEntity extends AbstractArrow implements IEntityAdditionalSpawnData {
        ...
        protected void onHit(@NotNull HitResult result) {
            ...
            if (!this.level().isClientSide){
                ...
                int timeAllows = ModifierUtil.getModifierLevel(tntarrow, DreamtinkerModifers.Ids.continuous_explode) * ContinuousExplodeTimes.get();
