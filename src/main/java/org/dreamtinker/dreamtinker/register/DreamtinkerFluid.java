...
public class DreamtinkerFluid {
    ...
    public static final FluidObject<ForgeFlowingFluid> molten_ascending_antimony = registerFluid("molten_ascending_antimony", 600,1000,3190,15,Material.WATER);
    public static final FluidObject<ForgeFlowingFluid> liquid_smoky_antimony = registerFluid("liquid_smoky_antimony", 600, 1000, 3190, 15, Material.WATER);
}
