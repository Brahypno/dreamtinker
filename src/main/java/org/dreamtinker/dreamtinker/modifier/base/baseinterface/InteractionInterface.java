...
public interface InteractionInterface extends LeftClickHook, EntityInteractionModifierHook, InventoryTickModifierHook {
    default void InteractionInterfaceInit(ModuleHookMap.Builder hookBuilder) {
        hookBuilder.addHook(this, DreamtinkerHook.LEFT_CLICK, ModifierHooks.ENTITY_INTERACT,ModifierHooks.INVENTORY_TICK);
    }
