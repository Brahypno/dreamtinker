...
public class DreamtinkerMaterialIds {
    ...
    public static final MaterialVariantId musou = create(desire_gem, "fulfill");
    ...
    public static final MaterialId Iesnium = new MaterialId(new ResourceLocation(MODID, "iesnium"));//undergarden
    //undergarden
    ...
    public static final MaterialId mnemonic = new MaterialId(new ResourceLocation(MODID, "malum_mnemonic"));
    public static final MaterialVariantId auric = create(mnemonic, "auric");
    ...
    public static final MaterialId LifeStealerBone = new MaterialId(new ResourceLocation(MODID, "bic_life_steal_bone"));
    public static final MaterialId KrampusHorn = new MaterialId(new ResourceLocation(MODID, "bic_krampus_horn"));
    public static final MaterialId NightMareClaw = new MaterialId(new ResourceLocation(MODID, "bic_nightmare_claw"));
    ...
    public static final MaterialId legendary_monsters_dinosaur_bone = new MaterialId(new ResourceLocation(MODID, "legendary_monsters_dinosaur_bone"));
    public static final MaterialId legendary_monsters_molten_metal = new MaterialId(new ResourceLocation(MODID, "legendary_monsters_molten_metal"));
    //inspired by FAA
