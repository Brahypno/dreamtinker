package org.brahypno.dreamtinker.tools.data.sprite;
    ...
    protected void addAllMaterials() {
        ...
        this.buildMaterial(DreamtinkerMaterialIds.sharp_bones)
            ...
            .transformer(GreyToSpriteTransformer.builder()
                                                ...
                                                .addARGB(102, 0xFFCBC6A5)
                                                .addARGB(140, 0xFFE8E5D2)
                                                .addARGB(178, 0xFFFCFBED)
                                                .addARGB(216, 0xFFFFFFFD)
                                                .addARGB(255, 0xFFFFFFFD)
                                                .build());
        this.buildMaterial(DreamtinkerMaterialIds.esca)
            .fletching().maille().statType(StatlessMaterialStats.BINDING)
            .statType(StatlessMaterialStats.BOWSTRING).repairKit()
            .fallbacks("cloth")
            .transformer(GreyToSpriteTransformer.builder()
                                                .addARGB(0, 0xFF0C1A22)
                                                .addARGB(63, 0xFF102328)
                                                .addARGB(102, 0xFF00585B)
                                                .addARGB(140, 0xFF00787D)
                                                .addARGB(178, 0xFF00989C)
                                                .addARGB(216, 0xFF23CFD5)
                                                .addARGB(255, 0xFFFFFFFF)
                                                .build());
        this.buildMaterial(DreamtinkerMaterialIds.angler_fang)
            .meleeHarvest().ranged().arrowHead().repairKit()
            .fallbacks("bone")
            .transformer(GreyToSpriteTransformer.builder()
                                                .addARGB(0, 0xFF182E2F)
                                                .addARGB(63, 0xFF364B15)
                                                .addARGB(102, 0xFF3A6F1A)
                                                .addARGB(140, 0xFF4F8C29)
                                                .addARGB(178, 0xFF76DB4C)
                                                .addARGB(216, 0xFFCBDADB)
                                                .addARGB(255, 0xFFFFFFFF)
                                                .build());
        this.buildMaterial(DreamtinkerMaterialIds.fin)
            .meleeHarvest().armor().repairKit()
            .fallbacks("bone", "cloth")
            .transformer(GreyToSpriteTransformer.builder()
                                                .addARGB(0, 0xFF0B1820)
                                                .addARGB(63, 0xFF1E2B33)
                                                .addARGB(102, 0xFF1D3839)
                                                .addARGB(140, 0xFF164769)
                                                .addARGB(178, 0xFF236491)
                                                .addARGB(216, 0xFF3AC2D5)
                                                .addARGB(255, 0xFF57E4F5)
                                                .build());
        ...
        this.buildMaterial(DreamtinkerMaterialIds.echo_alloy)
            ...
            .transformer(GreyToSpriteTransformer.builder()
                                                .addARGB(0, 0xFF241243)
                                                .addARGB(63, 0xFF2E1B53)
                                                .addARGB(102, 0xFF5C29A8)
                                                .addARGB(140, 0xFF915CE2)
                                                .addARGB(178, 0xFF20ADC1)
                                                .addARGB(216, 0xFF47E590)
                                                .addARGB(255, 0xFF9FEAA8)
                                                .build());
