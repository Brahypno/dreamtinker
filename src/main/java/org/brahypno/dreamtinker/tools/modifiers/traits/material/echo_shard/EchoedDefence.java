...
import static org.brahypno.dreamtinker.config.DreamtinkerCachedConfig.EchoDefenceRange;
import static org.brahypno.dreamtinker.config.DreamtinkerCachedConfig.EchoDefenceSpeed;
...
public class EchoedDefence extends Modifier implements DamageBlockModifierHook {
    ...
    public boolean isDamageBlocked(IToolStackView tool, ModifierEntry modifier, EquipmentContext context, EquipmentSlot slotType, DamageSource source, float amount) {
        ...
        List<LivingEntity> nearby = context.getEntity().level()
                                           .getEntitiesOfClass(LivingEntity.class, projectile.getBoundingBox().inflate(EchoDefenceRange.get()),
