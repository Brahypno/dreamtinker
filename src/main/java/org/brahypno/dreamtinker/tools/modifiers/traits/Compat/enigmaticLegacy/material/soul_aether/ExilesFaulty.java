package org.brahypno.dreamtinker.tools.modifiers.traits.Compat.enigmaticLegacy.material.soul_aether;
...
import org.brahypno.dreamtinker.tools.modifiers.traits.Compat.enigmaticLegacy.CursedRingBound;
...
public class ExilesFaulty extends Modifier implements ProjectileHitModifierHook, MeleeHitModifierHook, MonsterMeleeHitModifierHook, ModifierRemovalHook, ValidateModifierHook {
    ...
    private void curse_faulty(LivingEntity attacker, LivingEntity target, float damage) {
        ...
        if (attacker instanceof Player player){
            float cursesPercentage = (float) (EnigmaticLegacyCompat.getCurseAmount(player) * ExilesFaultyCurseHPPercentage.get());
            if (target != null){
