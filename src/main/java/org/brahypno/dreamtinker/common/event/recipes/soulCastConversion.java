...
import static org.brahypno.dreamtinker.config.DreamtinkerCachedConfig.SoulCastLoveLootChance;
...
public class soulCastConversion {
        ...
        for (int x = cx - RADIUS; x <= cx + RADIUS; x++) {
            for (int z = cz - RADIUS; z <= cz + RADIUS; z++) {
                ...
                if (isSoulGlass(state)){
                    ...
                    ItemStack soul_cast = new ItemStack(DreamtinkerCommon.soul_cast.get(), 1);
    ...
    public static void onBabySpawn(BabyEntitySpawnEvent event) {
        ...
        for (ItemEntity ie : level.getEntitiesOfClass(ItemEntity.class, box,
            ...
            ItemStack soul_cast = new ItemStack(DreamtinkerCommon.soul_cast.get(), count);
            CompoundTag tag = soul_cast.getOrCreateTag();
