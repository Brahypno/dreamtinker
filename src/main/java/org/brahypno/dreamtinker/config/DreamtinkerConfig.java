...
public class DreamtinkerConfig {
    ...
    public static final ForgeConfigSpec.DoubleValue ForceExplosionPower =
            builder.comment("how many times use per level for tnt Arrow").defineInRange("ForceExplosionPower", 12.0, 0, 30);
    public static final ForgeConfigSpec.DoubleValue realSweepRange =
            builder.comment("Range of real Sweep").defineInRange("realSweepRange", 6.0, 0, 30);
    ...
    public static final ForgeConfigSpec.DoubleValue rainbowHoneyRate =
            builder.comment("Base chance to get rainbow honey from a beehive").defineInRange("rainbowHoneyRate", 0.4, 0, 1);
    ...
    public static final ForgeConfigSpec.IntValue RedTime = builder.comment("The seconds used to level up itself ").defineInRange("RedTime", 4800, 1, 1000000);
    ...
    public static final ForgeConfigSpec.DoubleValue ArtsMaxManaBonus =
            builder.comment("Ars Nova compat: Max mana gain from Per Aspera Scriptum").defineInRange("ArtsMaxManaBonus", 120.0, 0, 1000);
    ...
    public static final ForgeConfigSpec.DoubleValue FirthMark =
            builder.comment("The damage Reduce for the first four warnings").defineInRange("FirthMark", 0.2, 0, 1);
